 ...
 $.ajax(
  {
    ...
    success: function(data)
    {
      if (data.errmsg == "")
      {
        ...
        [data.gDates21,Number(data.gData21)],[data.gDates22,Number(data.gData22)],[data.gDates23,Number(data.gData23)],[data.gDates24,Number(data.gData24)],[data.gDates25,Number(data.gData25)],[data.gDates26,Number(data.gData26)],[data.gDates27,Number(data.gData27)],[data.gDates28,Number(data.gData28)],[data.gDates29,Number(data.gData29)],[data.gDates30,Number(data.gData30)]];
